...
//
// ปฏิเสธ: เลขติดลบ (ส่วนลด), เลขที่ติดกับตัวอักษรหรือขีดกลางทางซ้าย (เลขบัญชี xxx-x-x4412-x),
// เลขที่ตามด้วยขีดกลาง (082-xxx-9492), เลขนำหน้าด้วยศูนย์ (016244…), และเลขยาวไม่มีตัวคั่น (TID#2026…)
